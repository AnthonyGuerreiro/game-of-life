...
public class GameOfLifeImpl implements GameOfLife {
    ...
    public GameOfLifeImpl(int height, int width, double aliveProbability, int randomCellsBornPerTurn, double interval) {
        if (height < 1
                || width < 1
                || interval < 0f
                || aliveProbability < 0
    ...
    public GameOfLifeImpl(Board board, int randomCellsBornPerTurn, double interval) {
